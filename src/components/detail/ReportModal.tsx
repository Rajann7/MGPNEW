...
const ERR: Record<string, string> = {
  ...
  ALREADY_REPORTED: "You've already reported this listing — it's with our moderation team.",
  RATE_LIMITED: "You've reached the daily report limit. Please try again tomorrow.",
...
export function ReportModal({
  ...
  function submit() {
    ...
    startTransition(async () => {
      const r = await submitReport({ targetType, targetId, category, description });
      if (!r.success) {
          ...
          >
            ...
            {done ? (
              <div className="flex flex-col items-center gap-2.5 px-5 py-8 text-center">
                ...
                <div className="text-[15px] font-semibold text-[#18181b]">Report submitted</div>
              ...
              <div className="flex flex-col gap-3 px-5 py-6 text-center">
                <p className="text-[13px] leading-[1.55] text-[#52525b]">
                  Please log in to report this {entityNoun}. This helps us keep
                  reports accountable.
                </p>
                <Link
              ...
              <div className="flex flex-col gap-3.5 px-5 py-4.5">
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="report-reason" className="text-[13px] font-medium text-[#3f3f46]">
                    Reason *
                  </label>
                ...
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="report-details" className="text-[13px] font-medium text-[#3f3f46]">
                    Details
                  </label>
                  <textarea
                    id="report-details"
                ...
                <div className="rounded-[10px] border border-[#f4f4f5] bg-[#fafafa] px-3 py-2 text-[11px] leading-[1.5] text-[#71717a]">
                  Reports go to the moderation queue. Duplicate and excessive reports
                  are rate-limited.
                </div>
