...
/**
 * B7-S12 — Broker Recently Viewed. Real history from recently_viewed_items
 * (RLS: own rows only), enriched with real titles. Honest empty state; unresolved
 * items show "No longer available" rather than being hidden or faked.
 */
export default async function BrokerRecentlyViewedPage() {
