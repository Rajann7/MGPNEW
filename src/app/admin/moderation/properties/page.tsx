...
export const metadata: Metadata = {
  title: "Property Moderation — Admin — My Gujarat Property",
...
export default async function PropertyModerationPage() {
  ...
  const result = await listModerationQueue("property");

  const permission = permissionsByModule["properties"] ?? null;
